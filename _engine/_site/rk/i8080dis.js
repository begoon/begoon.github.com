function i8080_disasm (binary) {
  ...
  switch (opcode) {
    ...
    case 0xc3: cmd = "JMP";   length = 3; arg1 = imm16; code = true; break;
    case 0xcb: cmd = "JMP?";  length = 3; arg1 = imm16; code = true; bad = true; break;

    case 0xcd: cmd = "CALL";  length = 3; arg1 = imm16; code = true; break;
    case 0xfd: cmd = "CALL?"; length = 3; arg1 = imm16; code = true; bad = true; break;
    ...
    case 0xc2: cmd = "JNZ";   length = 3; arg1 = imm16; code = true; break;

    case 0xc3: cmd = "JMP";   length = 3; arg1 = imm16; code = true; break;
    case 0xcb: cmd = "JMP?";  length = 3; arg1 = imm16; code = true; bad = true; break;

    case 0xc4: cmd = "CNZ";   length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xca: cmd = "JZ";    length = 3; arg1 = imm16; code = true; break;
    case 0xcc: cmd = "CZ";    length = 3; arg1 = imm16; code = true; break;

    case 0xcd: cmd = "CALL";  length = 3; arg1 = imm16; code = true; break;
    case 0xdd: cmd = "CALL?"; length = 3; arg1 = imm16; code = true; bad = true; break;
    case 0xed: cmd = "CALL?"; length = 3; arg1 = imm16; code = true; bad = true; break;
    case 0xfd: cmd = "CALL?"; length = 3; arg1 = imm16; code = true; bad = true; break;
    ...
    case 0xd2: cmd = "JNC";   length = 3; arg1 = imm16; code = true; break;
    case 0xd3: cmd = "OUT";   length = 2; arg1 = imm8; break;
    case 0xd4: cmd = "CNC";   length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xda: cmd = "JC";    length = 3; arg1 = imm16; code = true; break;
    case 0xdb: cmd = "IN";    length = 2; arg1 = imm8; break;
    case 0xdc: cmd = "CC";    length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xe2: cmd = "JPO";   length = 3; arg1 = imm16; code = true; break;
    case 0xe3: cmd = "XTXL";  length = 1; break;
    case 0xe4: cmd = "CPO";   length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xea: cmd = "JPE";   length = 3; arg1 = imm16; code = true; break;
    case 0xeb: cmd = "XCHG";  length = 1; break;
    case 0xec: cmd = "CPE";   length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xf2: cmd = "JP";    length = 3; arg1 = imm16; code = true; break;
    case 0xf3: cmd = "DI";    length = 1; break;
    case 0xf4: cmd = "CP";    length = 3; arg1 = imm16; code = true; break;
    ...
    case 0xfa: cmd = "JM";    length = 3; arg1 = imm16; code = true; break;
    case 0xfb: cmd = "EI";    length = 1; break;
    case 0xfc: cmd = "CM";    length = 3; arg1 = imm16; code = true; break;
  ...
  var instr = cmd + " ".repeat(4 - cmd.length); 
  if (arg1) instr += " " + arg1;
  if (arg2) instr += ", " + arg2;
