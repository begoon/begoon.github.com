...
уплощение, типа лопаточки), припой и канифоль. Для запайки пяточка,
...
повторяется для все ног. Если надо, можно подкапывать жидкого флюса.
...
купить в дополнению к паяльнику, припою, пинцету и кусачкам:
