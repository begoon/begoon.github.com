...
на программирования. Любая практика в чем-либо всегда полезна, 
...
Не думаю, что идеальный язык существует. Если удасться создать
достаточно развитый исскуственный интеллект, то мы в итоге придем
к использованию естественных языков, нежели язык программирования.
...
есть время обучить человек, то конкретные знания по С++ не проблема,
