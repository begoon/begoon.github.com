...
В плане функциональности версия на Go, как и [эрганговская][Улучшенный TCP/IP proxy на Erlang'e], ведет три лога: двунаправленный шестнадцатеричный дамп и бинарные логи в обоих направлениях, "от" и "к" удаленному хосту. [Питоновская версия][Мультипотоковый отладчик TCP/IP соединений] бинарные логи не ведет.
